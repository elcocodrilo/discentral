  ...
  body class:'container' , ->
    ...
    div class:"row twelve columns", ->
      div class:'define five columns', ->
        h4 class:'premise', "Premise:"
        p "There are significant economic efficiencies to be gained through disintermediation of public beauracracy and finance."
        p 'The cost of government can be drastically reduced, the complexity that multiplies beauracracy can be reconsidered.'
        p 'We must explore the alternatives to nineteenth century <span class="fiat"><b><i>fiat money.</b></i></fiat>'
